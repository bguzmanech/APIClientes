...
namespace APIClientes
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme) /*Autenticación*/
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                c.AddSecurityDefinition("oatuh2", new OpenApiSecurityScheme
                {
                    Description = "Authorizacion Standar, Usar Bearer. Ejemplo \"bearer {token}\"",
